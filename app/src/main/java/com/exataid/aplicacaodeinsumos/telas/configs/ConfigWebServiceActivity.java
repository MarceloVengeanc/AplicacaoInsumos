package com.exataid.aplicacaodeinsumos.telas.configs;
...
import com.exataid.aplicacaodeinsumos.telas.adapters.ConfigWSAdapter;
...
public class ConfigWebServiceActivity extends AppCompatActivity {
    ...
    void carregarDados() throws ExecutionException, InterruptedException {
        ListaConfigs = AIDatabase.getInstance(this).getConfigWSDAO().buscarTodas().get();
    }
        ...
        try {
            ...
            if (conteudo != null) {
                if (!conteudo.equals("")) {
                    ...
                    AIDatabase.getInstance(this).getConfigWSDAO().limpar();
                    ListaConfigs.clear();
                    ...
                    AIDatabase.getInstance(this).getConfigWSDAO().inserir(wsc);
