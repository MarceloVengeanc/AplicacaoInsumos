...
public class ConsultaAdapter extends RecyclerView.Adapter<ConsultaAdapter.ViewHolder> {
    ...
    private List<AplicacaoInsumos> listaApontamentoPlantio;
    private Context ctx;
    ...
    public ConsultaAdapter(List<AplicacaoInsumos> listaApontamentoPlantio, Context ctx, Resources res) {
...
//        private ConsultaCargaDeMudaAdapter consultaCargaDeMudaAdapter;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            txtCodFazenda = itemView.findViewById(R.id.txtProg);
            txtTalhao = itemView.findViewById(R.id.txtAplic);
...
////                try {
////                    listaCargaDeMudas = AIDatabase.getInstance(ctx).getCargaDeMudaDAO().buscarPorApontamento(apontamentoPlantio.getId()).get();
